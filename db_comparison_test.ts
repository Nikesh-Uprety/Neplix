...
async function runTest(name: string, url: string) {
...
async function main() {
  console.log("🚀 Starting Database Comparison Test\n");
  ...
  console.log("| Metric | Neon Tech | Railway | Winner |");
  console.log("|--------|-----------|---------|--------|");
  ...
  for (const metric of metrics) {
    ...
    console.log(`| ${metric} | ${neonTime}ms | ${railwayTime}ms | ${winner} |`);
  }
